                ...
                <div className="space-y-6">
                    {displayedCases.map((project, index) => (
                        <motion.div
                            ...
                            className="rounded-3xl border border-glass-border bg-glass-bg overflow-hidden transition-all hover:bg-slate-50/50 dark:hover:bg-white/5"
                        >
                            <button
                            ...
                            >
                                ...
                                <div className={`p-3 rounded-full bg-slate-100 dark:bg-white/5 transition-transform duration-300 ${openIndex === index ? 'rotate-180' : ''}`}>
                                    ...
                                    >
                                        <div className="p-6 md:p-8 pt-0 border-t border-glass-border/50">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-8 mt-6">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2 mb-3 text-amber-600 dark:text-yellow-400">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-8 mt-2">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2 mb-3 text-emerald-600 dark:text-green-400">
                                            ...
                                            {/* Learnings */}
                                            <div className="mt-8">
                                                <div className="flex items-center gap-2 mb-3 text-violet-600 dark:text-purple-400">
                                                    <BookOpen className="w-5 h-5" />
                                                    <h4 className="font-semibold">Key Learnings</h4>
                                                </div>
                                                <ul className="space-y-2">
                                                    {project.learnings?.map((item, i) => (
                                                        <li key={i} className="flex items-start gap-2 text-sm text-slate-600 dark:text-slate-300 italic">
                                                            <span className="text-violet-600 dark:text-purple-400">→</span>
                                                            {item}
                                                        </li>
                                                    ))}
                                                </ul>
                                            ...
                                            <div className="mt-8 flex justify-end">
                                                <Link
                                                    ...
                                                    className="inline-flex items-center gap-2 text-slate-600 hover:text-primary dark:text-white/70 dark:hover:text-white transition-colors text-sm font-medium group/link"
                                                >
