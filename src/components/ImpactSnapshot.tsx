...
import { TrendingUp, Users, Clock, Database, FileText, Zap, HelpCircle, ChevronDown } from "lucide-react";
...
export default function ImpactSnapshot() {
    ...
    return (
        <section id="impact" className="py-24 px-4 sm:px-6 lg:px-8 relative bg-[#FAFAFD] dark:bg-[#0A0A1A] transition-colors duration-300">
